...
:::warning[Important]
Before enabling, make sure the correct speaker/audio output device is selected in [Device Config](/docs/config-device).
:::
...
- [Device Config](/docs/config-device) - Configure audio devices
