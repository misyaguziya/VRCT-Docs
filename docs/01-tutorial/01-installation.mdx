...
3. Follow the instructions provided by the installer to proceed with the installation.  
    ...
    **Step 3**  
    ...
    :::info[v3.5.1+]
    The installer checks available disk space before downloading and extracting VRCT. If there is not enough space, it stops early and shows the amount required. Windows 10 version 1803 (April 2018) or later is required by the installer.
    :::
