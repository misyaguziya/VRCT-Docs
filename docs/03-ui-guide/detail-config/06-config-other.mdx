...
- **Support Our Development**: Enable or disable anonymous telemetry data collection to help improve VRCT.
  - When enabled, VRCT collects anonymous usage statistics (app starts, feature usage, etc.)
  - When disabled, no data is collected or transmitted
  - See the [Telemetry Guide](/docs/feature-guide/telemetry) for detailed information about what data is collected