...
- **Mic Record Timeout** : Set the timeout duration for microphone recording.
    ...
    - Set it to **0** to disable the recording timeout (unlimited recording). Phrase boundaries are still determined by silence detection and **Mic Phrase Timeout**.
...
- **Speaker Record Timeout** : Set the timeout duration for speaker recording.
    ...
    - Set it to **0** to disable the recording timeout (unlimited recording). Phrase boundaries are still determined by silence detection and **Speaker Phrase Timeout**.
