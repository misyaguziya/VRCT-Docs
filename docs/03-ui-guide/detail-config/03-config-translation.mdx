...
### Groq API
- **Groq API Key**: Enter your API key for using Groq translation services.
- **Select Groq Model**: Choose the specific Groq model for translation.
    - Various models are available for different languages and purposes.
    - Refer to the Groq documentation for details on each model.

### Open Router API
- **Open Router API Key**: Enter your API key for using Open Router translation services.
- **Select Open Router Model**: Choose the specific Open Router model for translation.
    - Various models are available for different languages and purposes.
    - Refer to the Open Router documentation for details on each model.
