...
VRCT continuously adds support for more translation engines. Check the settings window for the latest available options.
...
For detailed configuration, see the [Translation Settings Guide](/docs/config-translation).
