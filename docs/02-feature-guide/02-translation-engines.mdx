...
Please refer to the [ctranslate2-model-and-settings](../config-translation#ctranslate2-model-and-settings) page for more details.
:::
...
:::info[Info]
You can select different AI models in the [Translation Settings](../config-translation).
:::
...
For detailed configuration, see the [Translation Config Guide](../config-translation).
...
- [Translation Settings](../config-translation) - Configure translation engines
