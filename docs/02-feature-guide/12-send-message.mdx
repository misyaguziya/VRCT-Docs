...
Learn how to send messages with translation using VRCT. Messages can be sent via text input or voice input, and will be translated and sent to VRChat chatbox.
...
<!-- ![Voice Input](./img/voice-input.png) -->

:::warning[Important]
Before using voice input, configure your microphone in [Device Settings](/config-device).
:::
...
<!-- ![Voice with Translation](./img/voice-translation-complete.png) -->
...
<!-- ![Multiple Languages](./img/multi-language-send.png) -->
...
<!-- ![Engine Selection](./img/engine-select-send.png) -->
...
<!-- ![Chat History](./img/chat-history-sent.png) -->
...
- Prioritizes translated text

### Chatbox Display Duration

VRChat chatbox displays messages for a few seconds:
- Standard display time
- Automatically disappears
- Send new message to update
...
1. Create templates in settings
2. Quickly insert templates
3. Customize before sending

### Auto-send Options

Configure automatic sending:
- Voice input auto-send after pause
- Timed auto-send
...
- Use Shift + Up Arrow for last message
...
3. **Check Translation**: Review before sending important messages
4. **Choose Appropriate Engine**: Different engines for different quality
...
3. **Monitor Transcription**: Check text before it sends
4. **Adjust Microphone**: Proper distance and volume
...
For more troubleshooting, see the [FAQ](/faq).
