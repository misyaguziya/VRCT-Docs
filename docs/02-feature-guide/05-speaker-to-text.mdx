...
:::note[v3.5.1]
Set **Speaker Record Timeout** to **0** to disable the recorder's wall-clock timeout. Recording remains available until silence detection or **Speaker Phrase Timeout** ends the phrase.
:::
...
- [Device Config](/docs/config-device) - Configure speaker device
