...
<!-- ![Speaker2Log Toggle](./img/speaker2log-toggle.png) -->
...
2. When others speak in VRChat voice chat
...
<!-- ![Speaker with Translation](./img/speaker-translation-flow.png) -->
...
The system can transcribe multiple people speaking (though simultaneous speech may reduce accuracy).
...
2. **Reduce Echo**: Disable audio output to speakers when using VR headset
3. **Monitor System Resources**: Speaker transcription can be resource-intensive

## Use Cases

### Language Learning

- Understand foreign language conversations in VRChat
- Practice by reading transcriptions while listening
...
- Make sure you're not monitoring the audio device
...
- [Device Settings](/config-device) - Configure speaker device
