...
VRCT can capture audio from your speakers (VRChat voice chat) and:
...
<!-- ![Speaker2Log Toggle](./img/speaker2log-toggle-receive.png) -->

:::warning[Important]
Before enabling, make sure the correct speaker/audio output device is selected in [Device Settings](/config-device).
:::
...
<!-- ![Receive Without Translation](./img/receive-no-translation.png) -->
...
<!-- ![Chat History Received](./img/chat-history-received.png) -->
...
- Export or save chat logs (if available)

## Language Detection

### Automatic Language Detection

Some transcription/translation engines can automatically detect the spoken language:

1. Set source language to "Auto-detect"
2. VRCT will identify the language
3. Translate to your target language

:::info[Note]
Auto-detection accuracy depends on the engine and audio quality.
:::
...
- VRCT transcribes all audio from the speaker device
...
- Understand foreign language speakers in VRChat
- Read along while listening to practice comprehension
- Learn new vocabulary and phrases in context
- Improve listening skills with text support
...
3. **Check Multiple Translations**: Compare if accuracy is critical
4. **Learn Common Phrases**: Recognize patterns over time
...
3. **Participate Actively**: Engage in conversations, don't just lurk
...
- Speaker transcription drains battery faster
- Use power-saving transcription modes
- Consider plugging in for extended sessions
- Disable when battery is low
...
- Clear chat history regularly if needed
...
- [Device Settings](/config-device) - Configure audio devices
