...
refer to the docs on [VR Config Guide](../config-vr) or [VR Overlay Settings in Main Window](../main-window#overlayvr-button) for more details on accessing overlay settings.
